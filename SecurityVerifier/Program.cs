...
var policy1 = new FileUploadPolicy { AllowedCategories = FileTypeCategory.All };
...
var policy3 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy4 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy5 = new FileUploadPolicy { AllowedExtensions = new[] { ".jpg" } };
...
var policy6 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy7 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy9 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" }, AllowedMimeTypes = new[] { "image/png" } };
...
var policy10 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy11 = new FileUploadPolicy { AllowedExtensions = new[] { ".webp" } };
...
var policy12 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy13 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy14 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" } };
...
var policy15 = new FileUploadPolicy { AllowedExtensions = new[] { ".png" }, AllowMultipleExtensions = false };
...
var policy16 = new FileUploadPolicy { AllowedExtensions = new[] { ".zip" }, ArchiveMaxEntries = 10 };
...
var policy17 = new FileUploadPolicy { AllowedExtensions = new[] { ".zip" }, ArchiveMaxEntries = 10 };
...
var policy18 = new FileUploadPolicy { AllowedExtensions = new[] { ".zip" } };
...
var policy19 = new FileUploadPolicy { AllowedExtensions = new[] { ".zip" }, ArchiveMaxDepth = 5 };
...
var policy20 = new FileUploadPolicy { RequireMalwareScan = true };
...
var policy21 = new FileUploadPolicy { UnknownFilePolicy = UnknownFilePolicy.Allow, AllowedExtensions = new string[0] };
...
var policy22 = new FileUploadPolicy { ExtensionMismatchPolicy = ExtensionMismatchPolicy.Warn, AllowedExtensions = new[] { ".png" } };
